    ...
    <div className="ui-ux all">
      ...
      <div>
        ...
        <div className="mt-5 flex gap-x-2">
          <button
            type="button"
            className="text-gray-400 transition-all hover:text-cyan-400 duration-500 text-sm bg-card hover:bg-cardHover px-3 py-2 rounded-lg"
          >
            All
          </button>
          <button
