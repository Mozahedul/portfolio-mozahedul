          ...
          {archives?.length > 0
            ? archives?.map(archive => (
                ...
                >
                  ...
                  />
                  {/* hover section */}
                  <div className="group-hover:w-[100%] group-hover:h-[100%] group-hover:z-[888] rounded opacity-0 w-0 h-0 group-hover:opacity-100 overflow-hidden p-4 absolute transition-all duration-500 top-0 left-0 right-0; bottom-0 bg-card hover:shadow-[0_0_15px_5px_rgba(0,255,255,0.1)]">
